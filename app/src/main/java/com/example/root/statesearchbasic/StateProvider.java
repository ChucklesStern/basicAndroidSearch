...
public class StateProvider extends ContentProvider {
        ...
        public static String AUTHORITY = "com.example.android.searchabledict.DictionaryProvider2";
        ...
        private StateDatabase mDictionary;
        ...
        public boolean onCreate() {
            mDictionary = new StateDatabase(getContext());
            return true;
        }
        ...
        private Cursor getSuggestions(String query) {
            ...
            String[] columns = new String[] {
                    BaseColumns._ID,
                    StateDatabase.KEY_WORD,
                    StateDatabase.KEY_DEFINITION,
